package com.zhichen.parking.library.damajia.swipe;
...
public class SwipeLayout extends FrameLayout {
	...
	protected boolean isViewShowing(View child, Rect relativePosition, DragEdge availableEdge, int surfaceLeft, int surfaceTop,
			int surfaceRight, int surfaceBottom) {
		int childLeft = relativePosition.left;
		int childRight = relativePosition.right;
		int childTop = relativePosition.top;
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		// return super.onTouchEvent(event) || mIsBeingDragged || action ==
