...
import com.zhichen.parking.library.bgabanner.transformer.AccordionPageTransformer;
import com.zhichen.parking.library.bgabanner.transformer.AlphaPageTransformer;
import com.zhichen.parking.library.bgabanner.transformer.CubePageTransformer;
import com.zhichen.parking.library.bgabanner.transformer.DefaultPageTransformer;
import com.zhichen.parking.library.bgabanner.transformer.DepthPageTransformer;
import com.zhichen.parking.library.bgabanner.transformer.FadePageTransformer;
import com.zhichen.parking.library.bgabanner.transformer.FlipPageTransformer;
import com.zhichen.parking.library.bgabanner.transformer.RotatePageTransformer;
import com.zhichen.parking.library.bgabanner.transformer.StackPageTransformer;
import com.zhichen.parking.library.bgabanner.transformer.ZoomCenterPageTransformer;
import com.zhichen.parking.library.bgabanner.transformer.ZoomFadePageTransformer;
import com.zhichen.parking.library.bgabanner.transformer.ZoomPageTransformer;
import com.zhichen.parking.library.bgabanner.transformer.ZoomStackPageTransformer;
...
public class BGABanner extends RelativeLayout {
    ...
    private FlashViewListener mFlashViewListener;//向外提供图片点击接口
            ...
            view.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    if(mFlashViewListener!=null){
                        mFlashViewListener.onClick(position % mViews.size());
                    }
                }
            });
